...
namespace Game
{
    public class MegaObbyGameplay : BaseGameplay
    {
        public override void Start()
        {
            base.Start();

            int curCheckpointIndex = DataAchievement.megaObbyCheckpoint;
            ...
            checkpoints[DataAchievement.megaObbyCheckpoint + 1].ActiveArrow(true);
        }
        ...
        public override void EventCheckpoint(Event_Checkpoint e)
        {
            ...
            if (DataAchievement.megaObbyCheckpoint >= checkpointIndex) return;

            DataAchievement.SetMegaObbyCheckpoint(checkpointIndex);
            ...
            Easypapa.AdHelper.ShowInterstitial("megaobby_checkpoint");

            Easypapa.EasypapaAdSdk.LogEvent($"megaobby_checkpoint_{checkpoints.IndexOf(curCheckpoint):00}");
        }
    }
}
