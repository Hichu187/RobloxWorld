            ...
            for (int r = 0; r < renderers.Length; r++)
            {
                ...
                for (int i = 0; i < mats.Length; i++)
                {
                    ...
                    var st = new MatState
                    {
                        ...
                        surface = m.HasProperty("_Surface") ? m.GetFloat("_Surface") : (float?)null,
                        zwrite = m.HasProperty("_ZWrite") ? m.GetFloat("_ZWrite") : (float?)null,
                        srcBlend = m.HasProperty("_SrcBlend") ? m.GetFloat("_SrcBlend") : (float?)null,
                        dstBlend = m.HasProperty("_DstBlend") ? m.GetFloat("_DstBlend") : (float?)null
                    };
                    _saved.Add(st);
